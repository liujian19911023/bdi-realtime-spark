...
public class ProcessedOffsetManager {
  ...
  public static void persists(JavaPairDStream<Integer, Iterable<Long>> partitonOffset, final Properties props) {
  ...
  @SuppressWarnings("deprecation")
  public static void persists(DStream<Tuple2<Integer, Iterable<Long>>> partitonOffset, final Properties props) {
